...
export const USER_EMAIL_RESET_FAIL = "USER_EMAIL_RESET_FAIL";
export const USER_EMAIL_RESET_SUCCESS = "USER_EMAIL_RESET_SUCCESS";
export const USER_EMAIL_RESET_REQUEST = "USER_EMAIL_RESET_REQUEST";
